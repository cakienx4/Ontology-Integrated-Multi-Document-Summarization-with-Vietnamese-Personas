...
from pipeline.chinhluan.chinh_luan_phan_tich_lap_luan_oss import goi_llm_phan_tich_async
...
def build_chinh_luan_prompt(persona: dict, bai: dict, style: str, genre: str) -> tuple:
    ...
    Dưới đây là cấu trúc lập luận đã được phân tích sẵn từ bài viết trên. Đây là KHUNG BẮT BUỘC phải bám theo khi viết bản tóm tắt:
